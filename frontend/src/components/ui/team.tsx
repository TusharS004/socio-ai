...
export const AnimatedTooltip = ({
    ...
    isDarkMode: boolean; // Define the type for the prop
}) => {
                    ...
                    <AnimatePresence mode="popLayout">
                        {hoveredIndex === item.id && (
                            <motion.div
                                ...
                                className={`absolute -top-16 -left-1/2 translate-x-1/2 flex text-xs flex-col items-center justify-center rounded-md ${
                                    isDarkMode
